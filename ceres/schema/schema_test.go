...
func TestLoadSchema(t *testing.T) {
	os.Setenv("CERES_CONFIG_PATH", "../../test/.ceres-schema/config/config.json")
...
func TestWriteSchema(t *testing.T) {
	...
	byteExpectedContents, _ := os.ReadFile("../../test/.ceres-schema/schema.json")
	expectedContents := string(byteExpectedContents)

	WriteSchema()

	byteContents, _ := os.ReadFile("../../test/.ceres-schema/schema.json")
